...
## <a name="introduction_"></a> Introduction
...
## <a name="api_"></a> API
### <a name="#alloc-free_"></a> Creation and Deletion
#### <a name="#da_alloc_"></a> da_alloc
...
#### <a name="#da_reserve_"></a> da_reserve
...
### <a name="#header-data_"></a> Accessing Header Data
...
#### <a name="#da_foreach_"></a> da_foreach
...
#### <a name="#da_foreachr_"></a> da_foreachr
...
#### <a name="#container-type_"></a> container-style type
...
### <a name="costexpr-note_"></a> *A Note About Macros and Constant Expressions
...
## <a name="#tests_"></a> Building Unit/Performance Tests
