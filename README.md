...
2. [API](#api)
    + [Creation and Deletion](#alloc-free)
        + [da_alloc](#da_alloc)
        + [da_free](#da_free)
    + [Resizing](#resizing)
        + [da_resize](#da_resize)
    ...
    + [Removal](#Removal)
        + [da_remove](#da_remove)
        + [da_pop](#da_pop)
    + [Accessing Header Data](#header-data)
        + [da_length](#da_length)
    ...
    + [Misc. Utilities](#misc-utilities)
        ...
        + [container-style type](#container-type)
3. [*A Note About Macros and Constant Expressions](#costexpr-note)
4. [Building Unit/Performance Tests](#tests)
5. [License](#license)
...
## <a name="api"></a> API
### <a name="#alloc-free"></a> Creation and Deletion
#### <a name="#da_alloc"></a> da_alloc
...
#### <a name="#da_reserve"></a> da_reserve
...
#### <a name="#da_sinsert"></a> da_sinsert
...
### <a name="#header-data"></a> Accessing Header Data
...
#### <a name="#da_foreach"></a> da_foreach
...
#### <a name="#da_foreachr"></a> da_foreachr
...
#### <a name="#container-type"></a> container-style type
...
## <a name="#tests"></a> Building Unit/Performance Tests
